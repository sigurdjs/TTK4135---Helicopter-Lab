  ...
  ;%***********************
    ...
    ;%
    ;% Auto data (helicopter_no_feedback_P)
    ;%
      section.nData     = 24;
      section.data(24)  = dumData; %prealloc
      
	  ;% helicopter_no_feedback_P.K_ed
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_no_feedback_P.K_ei
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 1;
	
	  ;% helicopter_no_feedback_P.K_ep
	  ...
	  ;% helicopter_no_feedback_P.HILInitialize_set_other_outputs
	  section.data(19).logicalSrcIdx = 18;
	  section.data(19).dtTransOffset = 18;
	
	  ;% helicopter_no_feedback_P.HILInitialize_set_other_outpu_m
	  section.data(20).logicalSrcIdx = 19;
	  section.data(20).dtTransOffset = 19;
	
	  ;% helicopter_no_feedback_P.HILInitialize_set_other_outpu_k
	  section.data(21).logicalSrcIdx = 20;
	  section.data(21).dtTransOffset = 20;
	
	  ;% helicopter_no_feedback_P.HILInitialize_set_other_outpu_j
	  ...
	  ;% helicopter_no_feedback_P.HILReadEncoderTimebase_clock
	  section.data(1).logicalSrcIdx = 24;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_no_feedback_P.HILInitialize_hardware_clocks
	  ...
	  ;% helicopter_no_feedback_P.HILInitialize_pwm_modes
	  ...
	  ;% helicopter_no_feedback_P.HILInitialize_watchdog_digital_
	  ...
	  ;% helicopter_no_feedback_P.HILInitialize_analog_input_chan
	  ...
	  ;% helicopter_no_feedback_P.HILReadEncoderTimebase_channels
	  section.data(3).logicalSrcIdx = 34;
	  section.data(3).dtTransOffset = 16;
	
	  ;% helicopter_no_feedback_P.HILWriteAnalog_channels
	  section.data(4).logicalSrcIdx = 35;
	  section.data(4).dtTransOffset = 19;
	
	  ;% helicopter_no_feedback_P.HILInitialize_encoder_channels
	  ...
	  ;% helicopter_no_feedback_P.HILInitialize_active
	  section.data(1).logicalSrcIdx = 40;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_no_feedback_P.HILInitialize_final_digital_out
	  section.data(2).logicalSrcIdx = 41;
	  section.data(2).dtTransOffset = 1;
	
	  ;% helicopter_no_feedback_P.HILInitialize_initial_digital_o
	  section.data(3).logicalSrcIdx = 42;
	  section.data(3).dtTransOffset = 2;
	
	  ;% helicopter_no_feedback_P.HILInitialize_set_analog_input_
	  ...
	  ;% helicopter_no_feedback_P.HILInitialize_set_analog_output
	  ...
	  ;% helicopter_no_feedback_P.HILInitialize_set_analog_outp_e
	  ...
	  ;% helicopter_no_feedback_P.HILInitialize_set_analog_out_ex
	  section.data(11).logicalSrcIdx = 50;
	  section.data(11).dtTransOffset = 10;
	
	  ;% helicopter_no_feedback_P.HILInitialize_set_analog_outp_p
	  section.data(12).logicalSrcIdx = 51;
	  section.data(12).dtTransOffset = 11;
	
	  ;% helicopter_no_feedback_P.HILInitialize_set_clock_frequen
	  section.data(13).logicalSrcIdx = 52;
	  section.data(13).dtTransOffset = 12;
	
	  ;% helicopter_no_feedback_P.HILInitialize_set_clock_frequ_e
	  section.data(14).logicalSrcIdx = 53;
	  section.data(14).dtTransOffset = 13;
	
	  ;% helicopter_no_feedback_P.HILInitialize_set_clock_params_
	  section.data(15).logicalSrcIdx = 54;
	  section.data(15).dtTransOffset = 14;
	
	  ;% helicopter_no_feedback_P.HILInitialize_set_clock_param_c
	  section.data(16).logicalSrcIdx = 55;
	  section.data(16).dtTransOffset = 15;
	
	  ;% helicopter_no_feedback_P.HILInitialize_set_digital_outpu
	  section.data(17).logicalSrcIdx = 56;
	  section.data(17).dtTransOffset = 16;
	
	  ;% helicopter_no_feedback_P.HILInitialize_set_digital_out_b
	  section.data(18).logicalSrcIdx = 57;
	  section.data(18).dtTransOffset = 17;
	
	  ;% helicopter_no_feedback_P.HILInitialize_set_digital_out_c
	  section.data(19).logicalSrcIdx = 58;
	  section.data(19).dtTransOffset = 18;
	
	  ;% helicopter_no_feedback_P.HILInitialize_set_digital_ou_c1
	  section.data(20).logicalSrcIdx = 59;
	  section.data(20).dtTransOffset = 19;
	
	  ;% helicopter_no_feedback_P.HILInitialize_set_digital_out_a
	  section.data(21).logicalSrcIdx = 60;
	  section.data(21).dtTransOffset = 20;
	
	  ;% helicopter_no_feedback_P.HILInitialize_set_digital_out_j
	  section.data(22).logicalSrcIdx = 61;
	  section.data(22).dtTransOffset = 21;
	
	  ;% helicopter_no_feedback_P.HILInitialize_set_digital_out_m
	  section.data(23).logicalSrcIdx = 62;
	  section.data(23).dtTransOffset = 22;
	
	  ;% helicopter_no_feedback_P.HILInitialize_set_encoder_count
	  ...
	  ;% helicopter_no_feedback_P.HILInitialize_set_encoder_param
	  ...
	  ;% helicopter_no_feedback_P.HILInitialize_set_other_outpu_l
	  section.data(28).logicalSrcIdx = 67;
	  section.data(28).dtTransOffset = 27;
	
	  ;% helicopter_no_feedback_P.HILInitialize_set_pwm_outputs_a
	  ...
	  ;% helicopter_no_feedback_P.HILInitialize_set_pwm_output_ap
	  section.data(32).logicalSrcIdx = 71;
	  section.data(32).dtTransOffset = 31;
	
	  ;% helicopter_no_feedback_P.HILInitialize_set_pwm_outputs_o
	  section.data(33).logicalSrcIdx = 72;
	  section.data(33).dtTransOffset = 32;
	
	  ;% helicopter_no_feedback_P.HILInitialize_set_pwm_params_at
	  ...
	  ;% helicopter_no_feedback_P.Gain_Gain
	  ...
	  ;% helicopter_no_feedback_P.Gain_Gain_a
	  ...
	  ;% helicopter_no_feedback_P.PitchTransferFcn_C
	  ...
	  ;% helicopter_no_feedback_P.Gain_Gain_lv
	  ...
	  ;% helicopter_no_feedback_P.Gain1_Gain
	  ...
	  ;% helicopter_no_feedback_P.Frontgain_Gain
	  section.data(27).logicalSrcIdx = 101;
	  section.data(27).dtTransOffset = 26;
	
	  ;% helicopter_no_feedback_P.Gain_Gain_a1
	  ...
	  ;% helicopter_no_feedback_P.HILReadEncoderTimebase_Active
	  section.data(1).logicalSrcIdx = 107;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_no_feedback_P.HILWriteAnalog_Active
  ...
  ;%**************************
    ...
    ;%
    ;% Auto data (helicopter_no_feedback_B)
    ;%
      section.nData     = 16;
	  ...
	  ;% helicopter_no_feedback_B.Gain_e
	  section.data(9).logicalSrcIdx = 8;
	  section.data(9).dtTransOffset = 8;
	  ...
	  ;% helicopter_no_feedback_B.Gain1
	  section.data(12).logicalSrcIdx = 11;
	  section.data(12).dtTransOffset = 11;
	  ...
	  ;% helicopter_no_feedback_B.Gain_l
	  section.data(14).logicalSrcIdx = 13;
  ...
  ;%*******************
    ...
    ;%
    ;% Auto data (helicopter_no_feedback_DW)
    ;%
      section.nData     = 13;
      section.data(13)  = dumData; %prealloc
      
	  ;% helicopter_no_feedback_DW.HILInitialize_AIMinimums
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_no_feedback_DW.HILInitialize_AIMaximums
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 8;
	
	  ;% helicopter_no_feedback_DW.HILInitialize_AOMinimums
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 16;
	
	  ;% helicopter_no_feedback_DW.HILInitialize_AOMaximums
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 24;
	
	  ;% helicopter_no_feedback_DW.HILInitialize_AOVoltages
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 32;
	
	  ;% helicopter_no_feedback_DW.HILInitialize_FilterFrequency
	  section.data(6).logicalSrcIdx = 5;
	  section.data(6).dtTransOffset = 40;
	
	  ;% helicopter_no_feedback_DW.HILInitialize_POSortedFreqs
	  section.data(7).logicalSrcIdx = 6;
	  section.data(7).dtTransOffset = 48;
	
	  ;% helicopter_no_feedback_DW.HILInitialize_POValues
	  section.data(8).logicalSrcIdx = 7;
	  section.data(8).dtTransOffset = 56;
	
	  ;% helicopter_no_feedback_DW.TimeStampA
	  section.data(9).logicalSrcIdx = 8;
	  section.data(9).dtTransOffset = 64;
	
	  ;% helicopter_no_feedback_DW.LastUAtTimeA
	  section.data(10).logicalSrcIdx = 9;
	  ...
	  ;% helicopter_no_feedback_DW.LastUAtTimeB
	  section.data(12).logicalSrcIdx = 11;
	  section.data(12).dtTransOffset = 67;
	
	  ;% helicopter_no_feedback_DW.HILWriteAnalog_Buffer
	  section.data(13).logicalSrcIdx = 12;
	  ...
	  ;% helicopter_no_feedback_DW.ToFile_PWORK.FilePtr
	  section.data(1).logicalSrcIdx = 15;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_no_feedback_DW.u_PWORK.TimePtr
	  section.data(2).logicalSrcIdx = 16;
	  section.data(2).dtTransOffset = 1;
	
	  ;% helicopter_no_feedback_DW.ElevationScopedegs_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 17;
	  section.data(3).dtTransOffset = 2;
	
	  ;% helicopter_no_feedback_DW.ElevationScopedeg_PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 18;
	  section.data(4).dtTransOffset = 3;
	
	  ;% helicopter_no_feedback_DW.PitchScopedeg_PWORK.LoggedData
	  section.data(5).logicalSrcIdx = 19;
	  section.data(5).dtTransOffset = 4;
	
	  ;% helicopter_no_feedback_DW.PtichrateScopedegs_PWORK.LoggedData
	  section.data(6).logicalSrcIdx = 20;
	  section.data(6).dtTransOffset = 5;
	
	  ;% helicopter_no_feedback_DW.PtichrateScopedegs1_PWORK.LoggedData
	  section.data(7).logicalSrcIdx = 21;
	  section.data(7).dtTransOffset = 6;
	
	  ;% helicopter_no_feedback_DW.TravelrateScopedegs_PWORK.LoggedData
	  section.data(8).logicalSrcIdx = 22;
	  section.data(8).dtTransOffset = 7;
	
	  ;% helicopter_no_feedback_DW.TravelScopedeg_PWORK.LoggedData
	  section.data(9).logicalSrcIdx = 23;
	  section.data(9).dtTransOffset = 8;
	
	  ;% helicopter_no_feedback_DW.Backmotor_PWORK.LoggedData
	  section.data(10).logicalSrcIdx = 24;
	  section.data(10).dtTransOffset = 9;
	
	  ;% helicopter_no_feedback_DW.Frontmotor_PWORK.LoggedData
	  section.data(11).logicalSrcIdx = 25;
	  section.data(11).dtTransOffset = 10;
	
	  ;% helicopter_no_feedback_DW.HILWriteAnalog_PWORK
	  ...
	  ;% helicopter_no_feedback_DW.HILInitialize_ClockModes
	  section.data(1).logicalSrcIdx = 27;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_no_feedback_DW.HILInitialize_QuadratureModes
	  section.data(2).logicalSrcIdx = 28;
	  section.data(2).dtTransOffset = 3;
	
	  ;% helicopter_no_feedback_DW.HILInitialize_InitialEICounts
	  section.data(3).logicalSrcIdx = 29;
	  section.data(3).dtTransOffset = 11;
	
	  ;% helicopter_no_feedback_DW.HILInitialize_POModeValues
	  section.data(4).logicalSrcIdx = 30;
	  section.data(4).dtTransOffset = 19;
	
	  ;% helicopter_no_feedback_DW.HILInitialize_POAlignValues
	  section.data(5).logicalSrcIdx = 31;
	  section.data(5).dtTransOffset = 27;
	
	  ;% helicopter_no_feedback_DW.HILInitialize_POPolarityVals
	  section.data(6).logicalSrcIdx = 32;
	  section.data(6).dtTransOffset = 35;
	
	  ;% helicopter_no_feedback_DW.HILReadEncoderTimebase_Buffer
	  ...
	  ;% helicopter_no_feedback_DW.HILInitialize_POSortedChans
	  ...
	  ;% helicopter_no_feedback_DW.ToFile_IWORK.Count
	  section.data(1).logicalSrcIdx = 35;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_no_feedback_DW.u_IWORK.PrevIndex
  ...
  targMap.checksum0 = 1132350995;
  targMap.checksum1 = 3543923485;
  targMap.checksum2 = 3882204645;
  targMap.checksum3 = 1401270199;
